return {
  ...
  custom_settings_id="CUSTOM_DREAMISLAND-MASTER",
  custom_settings_name="Dreamisland-Master",
  custom_worldgen_desc="",
  custom_worldgen_id="CUSTOM_DREAMISLAND-MASTER",
  custom_worldgen_name="Dreamisland-Master",
  desc="标准《饥荒》体验。",
  hideminimap=false,
